              ...
              <Row>
                  <Col md={8} className="home-about-description">
                      ...
                      <p className="home-about-body">
                          I fell in love with programming, so I keep learning
                          more technologies 😎
                          <br />
                          ...
                          <i>
                              <b className="purple">
                                  Full-Stack web development, the creation of
                                  new technologies
                              </b>{" "}
                              and also in areas related to{" "}
                              <b className="purple">
                                  Artificial Intelligence, especially Deep
                                  Learning.
                              </b>
                          </i>
                          <br />
                          <br />I enjoy applying my passion for developing
